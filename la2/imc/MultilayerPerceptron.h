...
public:
	...
	// errorFunction=1 => Cross Entropy // errorFunction=0 => MSE
	void runBackPropagation(Dataset * trainDataset, Dataset * testDataset, int maxiter, double *errorTrain, double *errorTest, double *ccrTrain, double *ccrTest, int *count, int errorFunction);
